...
{
    public class PlannerComponentUniversalCpp : IPlannerComponent
    {
        ...
        {
            comp.SetParams(new PlannerComponent.PlanningArgs
            {
        ...
        private static PlannerComponent.PlanningTimeType Convert(PlannerComponent.Interface.PlanningTimeType val)
        {
            switch (val)
            {
                case PlannerComponent.Interface.PlanningTimeType.Arrival: return PlannerComponent.PlanningTimeType.Arrival;
                case PlannerComponent.Interface.PlanningTimeType.Departure: return PlannerComponent.PlanningTimeType.Departure;
                default: throw new NotImplementedException();
            }
        }

        private PlannerComponent.PlanningAspect Convert(PlannerComponent.Interface.PlanningAspect val)
        {
            switch (val)
            {
                case PlannerComponent.Interface.PlanningAspect.Time: return PlannerComponent.PlanningAspect.Time;
                case PlannerComponent.Interface.PlanningAspect.TransferCount: return PlannerComponent.PlanningAspect.TransferCount;
                case PlannerComponent.Interface.PlanningAspect.WalkDistance: return PlannerComponent.PlanningAspect.WalkDistance;
                default: throw new NotImplementedException();
            }
        }
    }
