...
//    public partial class TiltEffectCustom : DependencyObject
//    {
//        /// <summary>
...
//            PlaneProjection projection = element.Projection as PlaneProjection;
//            projection.RotationY = angle * xAngleContribution * xDirection * scale;
//            projection.RotationX = angle * (1 - xAngleContribution) * yDirection * scale;
//            //projection.GlobalOffsetZ = -depression;
//            projection.GlobalOffsetZ = -25;
//        }
