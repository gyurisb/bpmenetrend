...
namespace TransitBase.BusinessLogic.Helpers
{
    public class DynamicDictionary : DynamicObject, INotifyPropertyChanged
    {
        public DynamicDictionary(Dictionary<string, object> internalValues = null)
        {
            InternalValues = internalValues ?? new Dictionary<string, object>();
        }
